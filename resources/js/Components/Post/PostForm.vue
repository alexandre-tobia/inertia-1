    ...
    <jet-form-section @submitted="submitForm">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <textarea id="content"  class="mt-1 block w-full" v-model="form.content" autocomplete="content"></textarea>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <button @click="toggle" type="button"  :class="[form.published ? 'bg-indigo-600' : 'bg-gray-200' ]" class="relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" aria-pressed="false">
                    <span class="sr-only">Use setting</span>
                    <!-- Publié: "translate-x-5", Non publié: "translate-x-0" -->
                    <span aria-hidden="true"  :class="[form.published ? 'translate-x-5' : 'translate-x-0' ]" class="pointer-events-none inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200"></span>
                </button>
